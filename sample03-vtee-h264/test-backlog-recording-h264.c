...
#define VIDEO_CAPS "video/x-raw,width=680,height=480,format=I420,framerate=(fraction)5/1"
...
main (int argc, char **argv)
{
  ...
  app.pipeline =
      ...
      "vtee. ! queue ! avdec_h264 ! videoconvert ! videoscale ! ximagesink "
      "vtee. ! queue name=vrecq ! mp4mux name=mux ! filesink async=false name=filesink",
      NULL);
